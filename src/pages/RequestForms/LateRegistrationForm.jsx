    ...
    <div className="max-w-5xl mx-auto p-8 bg-white shadow-xl rounded-md my-10 border-t-8 border-orange-600">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-gray-800">
          {isEditMode ? '[แก้ไข] ' : ''}ใบคำร้องขอลงทะเบียนเรียนล่าช้า
        </h2>
      </div>
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
          ...
          <div className="flex justify-end items-center gap-4 bg-gray-50 p-4 rounded border border-gray-200">
            ...
            <input type="number" value={totalCredits} disabled className="border-b-2 border-orange-500 focus:outline-none w-24 text-center text-xl font-bold text-orange-700 bg-gray-100 cursor-not-allowed" placeholder="0" />
          </div>
